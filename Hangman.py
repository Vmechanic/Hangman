...
def findLetter(list,guess):
    ...
    return letterIndicesword = "This is hangman".lower()
...
def notifyPlayer():
    ...
    if ((8 - countWrongGuesses) == 1):
        print("You have 1 more guess left before you lose.")
    else:
        print("You have " + str(8 - countWrongGuesses) + " guesses left before you lose.")
    print(wrongGuesses)
    print("".join(template))


print("".join(template) + "\n")
print("There are " + str(len(word.replace(" ", ""))) +
      " letters you have to guess (spaces excluded).\n")
